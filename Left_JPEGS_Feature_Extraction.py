...
directory = r'C:\Users\16154\vu\Group Project\project 4\Handwriting_CNN\Preprocessed_Left_JPEGS'
...
results_df.to_csv('Left_JPEGS_File_Extraction.csv', index=False)

print("Left feature extraction completed and results saved")
