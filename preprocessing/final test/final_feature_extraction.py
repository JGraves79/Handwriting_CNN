...
directory = r'C:\Users\16154\vu\Group Project\project 4\Handwriting_CNN\final_test\mnist'
...
df.to_csv('handwriting_analysis_results.csv', index=False)

print("Handwriting analysis complete. Results saved to handwriting_analysis_results.csv")