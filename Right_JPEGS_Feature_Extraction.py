...
directory = r'C:\Users\16154\vu\Group Project\project 4\Handwriting_CNN\Preprocessed_Right_JPEGS'
...
results_df.to_csv('Right_JPEGS_File_Extraction.csv', index=False)
