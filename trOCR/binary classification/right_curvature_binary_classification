...
# Load your dataset
df = pd.read_csv('C:/Users/16154/vu/Group Project/project 4/Handwriting_CNN/trOCR/right_feature_extraction_results.csv')

# Print column names to verify
print(df.columns)

# Calculate the mean for classification
curvature_mean = (0.699 + 0.720) / 2
...
df.to_csv('classified_curvature_right_handed_results.csv', index=False)
